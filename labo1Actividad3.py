...
#Nos basamos en el código de la siguiente dirección (clase minmax_decision y clase alpha_beta_cutoff_search):
...
def alpha_beta_cutoff_search(state, game, d=4, cutoff_test=None, eval_fn=None):
    ...
    def max_value(state, alpha, beta, depth):
        if cutoff_test(state, depth):
            print("Se podó en el estado: "+str(state)+", produndidad:"+str(depth))
...
#Actividad 3 
#considerar que por tema de recursividad: 
#se entregara la poda desde, el mas profundo hacia el menos profundo
